...
<template>
    <div class="nlogin-view">
        ...
        <div class="row">
            ...
            <div class="row-code">
                <input id="imgCode" v-model="imgCode" type="text" name="imgCode" placeholder="请输入图中的数字" required />
        ...
        <div class="row">
            ...
            <div class="row-code">
                <input id="msgCode" v-model="msgCode" type="text" name="msgCode" placeholder="请输入短信验证码" required />
